...
discussions-to: [https://ethereum-magicians.org/t/eip-7998-turn-randao-reveal-into-a-vrf/24999](https://ethereum-magicians.org/t/eip-7998-turn-randao-reveal-into-a-vrf/24999)
status: Draft
...
We considered adding the *latest* RANDAO mix rather than that from the previous epoch so that we could obtain per-slot unpredictability, but that would cause fork ambiguity in the future if `randao_reveal` is used to implement SSLE.
...
No pandas was hurt during edit of this EIP. This line was added trough dip.box editor with no need of forking repository.&#x20;